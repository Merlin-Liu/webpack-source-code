...
class Compilation {
	...
	_addModule(module, callback) {
		consola.info('addModule: Compilation.modules.add(module) ')
	...
	handleModuleCreation({ factory, dependencies, originModule, context }, callback) {
		...
		consola.info(`12、进入handleModuleCreation方法，执行factorizeModule方法，此处即将创建的Module的为${dependencies[0].request}`)
		// factorize =》 因式分解
	...
	_factorizeModule({ currentProfile, factory, dependencies, originModule, context }, callback) {
		consola.info('13、_factorizeModulez')
		if (currentProfile !== undefined) {
	...
	addModuleChain(context, dependency, callback) {
		...
		consola.info('11、进入addModuleChain方法，执行handleModuleCreation方法创建Module')
	...
	addEntry(context, entry, name, callback) {
		...
		consola.info('10、进入Compilation的addEntry方法中，执行Compilation的addModuleChain方法')
